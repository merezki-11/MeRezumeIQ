...
git clone https://github.com/merezki-11/MeRezumeIQ.git
cd MeRezumeIQ
...
Start the Streamlit or Flask app (depending on your version):
streamlit run app.py
Then open the displayed local URL (usually http://localhost:8501) to access the web interface.
